<template>
  <div>
    <!-- Header -->
    <div class="mb-6">
      <h2 class="text-xl font-bold text-gray-900 dark:text-gray-100">Organization Teams</h2>
      <p class="text-sm text-gray-500 dark:text-gray-400">{{ teams.length }} teams &middot; {{ uniqueMemberCount }} unique members</p>
    </div>
    ...
    <div v-else-if="teams.length === 0" class="text-center py-12">
      ...
      <p class="text-gray-500 dark:text-gray-400">No teams found. Configure roster sync in Settings to populate the team roster.</p>
    </div>
...
function handleSelectTeam(team) {
  nav.navigateTo('team-roster', { teamKey: team.key })
}
</script>
