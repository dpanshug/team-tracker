...
export function useSavedFilters() {
  ...
  function loadFilters() {
    try {
      return JSON.parse(localStorage.getItem('teamTrackerFilters')) || []
    } catch {
      return []
    }
  }
  ...
  function loadActiveFilterId() {
    try {
      return localStorage.getItem('teamTrackerActiveFilterId') || null
    } catch {
      return null
    }
  }
  ...
  function persistFilters() {
    localStorage.setItem('teamTrackerFilters', JSON.stringify(filters.value))
  }
  ...
  function deleteFilter(id) {
    ...
    if (activeFilterId.value === id) {
      ...
      localStorage.removeItem('teamTrackerActiveFilterId')
    }
    persistFilters()
  }
  ...
  function setActiveFilter(id) {
    ...
    if (id === null) {
      ...
      localStorage.setItem('teamTrackerActiveFilterId', id)
    }
  }
